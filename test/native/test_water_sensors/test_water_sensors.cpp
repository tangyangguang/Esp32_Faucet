...
void test_tds_raw_voltage_restore_preserves_low_range_resolution() {
    TEST_ASSERT_EQUAL_UINT16(12, tdsModuleVoltageMvFromAdcRaw(899, 256, 10000, 15000));
    TEST_ASSERT_EQUAL_UINT16(0, tdsModuleVoltageMvFromAdcRaw(-1, 256, 10000, 15000));
}
...
int main(int argc, char** argv) {
    ...
    RUN_TEST(test_tds_raw_voltage_restore_preserves_low_range_resolution);
